...
/* package fp16-Pongout-0.1.0.0 */
#define VERSION_fp16_Pongout "0.1.0.0"
#define MIN_VERSION_fp16_Pongout(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fp16-Pongout-0.1.0.0"

#define CURRENT_PACKAGE_KEY "fp16-Pongout-0.1.0.0"
